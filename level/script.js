...
if(localStorage.getItem("addSubRecord")>0){
document.getElementById("recordTop").innerHTML = localStorage.getItem("addSubRecord");}
...
////////////////////////////////////////////
 ...
 function lose(){
if(localStorage.getItem("addSubRecord")<scoreId){
localStorage.setItem("addSubRecord", scoreId);
document.getElementById("recordTop").innerHTML = localStorage.getItem("addSubRecord");}
