...
if(localStorage.getItem("divRecord") > 0){
document.getElementById("recordTop").innerHTML = localStorage.getItem("divRecord");	}
...
result=rnd1/rnd2;
 ...
 function lose(){
if(localStorage.getItem("divRecord")<scoreId){localStorage.setItem("divRecord", scoreId);
document.getElementById("recordTop").innerHTML = localStorage.getItem("divRecord");}
