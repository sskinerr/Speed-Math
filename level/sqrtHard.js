...
document.getElementById("recordTop").innerHTML = localStorage.getItem("sqrtHRecord");
...
////////////////////////////////////////////
 ...
 function lose(){
 if(localStorage.getItem("sqrtHRecord")<scoreId){
localStorage.setItem("sqrtHRecord", scoreId);
 document.getElementById("recordTop").innerHTML = localStorage.getItem("sqrtHRecord");}
...
math()}
 ...
 timerId = setTimeout("winLose()", 3500);
 timer();}
...
setTimeout("timerAnimation.style.width = 0+'px';timerAnimation.style.transition = '3.5s'",400)}
