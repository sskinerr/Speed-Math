 ...
 var maksRandome = 9;
 	...
 	if(localStorage.getItem("ASHRecord") > 0){
 document.getElementById("recordTop").innerHTML = localStorage.getItem("ASHRecord");	}
...
document.getElementById("top").style.background = "#747474";}
 ...
 if(localStorage.getItem("ASHRecord")<scoreId){
localStorage.setItem("ASHRecord", scoreId);
 document.getElementById("recordTop").innerHTML = localStorage.getItem("ASHRecord");}
...
math()}
 ...
 timerId = setTimeout("winLose()", 3000);
 timer();}
...
setTimeout("timerAnimation.style.width = 0+'px';timerAnimation.style.transition = '2.5s'",400)}
