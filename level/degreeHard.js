 ...
 if(localStorage.getItem("hardDegRecord") > 0){
 document.getElementById("recordTop").innerHTML = localStorage.getItem("hardDegRecord");	}
...
document.getElementById("top").style.background = "#747474";}
 ...
 function lose(){
 if(localStorage.getItem("hardDegRecord")<scoreId){
localStorage.setItem("hardDegRecord", scoreId);
document.getElementById("recordTop").innerHTML = localStorage.getItem("hardDegRecord");}
...
document.getElementById("gameOver").style.transform = "translate(-50%,65%)";
...
setTimeout("timerAnimation.style.width = 0+'px';timerAnimation.style.transition = 'linear 3.6s'",600)}
