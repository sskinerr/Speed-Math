...
if(localStorage.getItem("subRecord")>0){
document.getElementById("recordTop").innerHTML = localStorage.getItem("subRecord");}
...
////////////////////////////////////////////
 ...
 function lose(){
if(localStorage.getItem("subRecord")<scoreId){
localStorage.setItem("subRecord", scoreId);
document.getElementById("recordTop").innerHTML = localStorage.getItem("subRecord");}
